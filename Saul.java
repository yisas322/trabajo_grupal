...
public class Saul {
    ...
    public static void lubricantes(Scanner gaa) {
        ...
        double[] precios = {275.60, 244.57, 126.60, 122.23, 116.91};

        System.out.println("\nLubricantes disponibles:");
        for (int i = 0; i < lubricantes.length; i++) {
            System.out.println((i + 1) + "- Lubricante " + lubricantes[i] + " ---> S/ " + precios[i]);
        }
        ...
        double totalLubricante = precioLubricante * cantidadLubricante;
    ...
    private static boolean procesarPagoConTarjeta(Scanner scanner, double monto, double igv) {
        ...
        String anoVencimiento = scanner.next();

        while (mesVencimiento.length() != 2 || anoVencimiento.length() != 2) {
            System.out.println("Formato de fecha inválido. Debe ser MM/AA.");
            System.out.print("Ingrese el mes de vencimiento (MM): ");
            mesVencimiento = scanner.next();
            System.out.print("Ingrese el año de vencimiento (AA): ");
            anoVencimiento = scanner.next();
        }
    ...
    public static void comprarGas(Scanner scanner) {
        String[] tiposGas = {"Balón de 10kg", "Balón de 15kg", "Balón de 45kg"};
        double[] preciosGas = {50.00, 70.00, 140.00};

        System.out.println("--- GASES DISPONIBLES ---");
        for (int i = 0; i < tiposGas.length; i++) {
            System.out.println((i + 1) + "- " + tiposGas[i] + " (S/ " + preciosGas[i] + ")");
        }
    ...
    private static boolean procesarPagoConTarjeta(Scanner scanner, String nombreCliente, double precioGas, double igv, double totalConIGV) {
        ...
        if (pagoExitoso) {
            generarBoleta("Tarjeta de Crédito", nombreCliente, precioGas, igv, totalConIGV, totalConIGV, 0);
        }
    ...
    public static void comprarlistol(Scanner gaa) {
        ...
        final double IGV = 0.18; // IGV es el 18% (0.18)
        ...
        double subtotal = totalPedido;
        double montoIGV = subtotal * IGV;
        double totalConIGV = subtotal + montoIGV;
    ...
    public static void carwash(Scanner gaa) {
        ...
        String nombreCliente = gaa.nextLine();
        ...
        while (true) {
            ...
            int tipoLavadoIndex = gaa.nextInt() - 1;
